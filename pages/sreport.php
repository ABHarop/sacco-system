...
<div class="report">
  ...
  <i class="report-head4">PERSONAL SAVINGS REPORT</i></p>
...
<form >
  ...
  <?php 
      ...
      $q=mysqli_query($con,"SELECT * FROM savehist WHERE memberId = '$memberId' ");
      $rr=mysqli_num_rows($q);
      if(!$rr)
      {
      echo "<h2 style='color:red;font-style: italic;font-size:20px;padding-left:14px;padding-right:14px;margin-left:5%'>No Savings Data Available...</h2>";
