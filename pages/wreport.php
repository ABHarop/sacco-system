...
<div class="report">
  ...
  <i class="report-head4">PERSONAL WITHDRAW REPORT</i></p>
...
<form >
  ...
  <?php 
      ...
      $q=mysqli_query($con,"SELECT * FROM withdrawtb WHERE memberId = '$memberId' ");
      $rr=mysqli_num_rows($q);
      if(!$rr)
      {
      echo "<h2 style='color:red;font-style: italic;font-size:20px;padding-left:14px;padding-right:14px;margin-left:5%'>No Withdraw Data Available...</h2>";
